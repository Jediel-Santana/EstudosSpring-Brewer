...
public class MenuAttributeTagProcessor extends AbstractAttributeTagProcessor {
	...
	private static final String ELEMENT_NAME = "menu";
	private static int precendencia = 1000;

	public MenuAttributeTagProcessor(String dialectPrefix) {
		super(TemplateMode.HTML, dialectPrefix, null, false, ELEMENT_NAME, true, precendencia, true);
	}
